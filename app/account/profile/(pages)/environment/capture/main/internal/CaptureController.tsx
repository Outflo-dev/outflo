...
/* ==========================================================
   OUTFLO — ENVIRONMENT CAPTURE CONTROLLER
   File: app/account/profile/(pages)/environment/capture/main/internal/CaptureController.tsx
   Scope: Own capture control drilldown motion and navigation orchestration
   Last Updated:
   - ms: 1779269374486
   - iso: 2026-05-20T09:29:34.486Z
   - note: add capture control controller
   ========================================================== */
    ...
    return (
        <Motion show={show} direction={direction}>
            <main style={MAIN_STYLE}>
                <AppFrame>
                    <CaptureView model={model} onBack={handleBack} />
                </AppFrame>
            </main>
        </Motion>
    );
