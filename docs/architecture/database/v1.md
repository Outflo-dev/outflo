...
This document defines the database architecture and invariants for Outflō.

Purpose:
- Prevent schema drift
- Define canonical entities
- Document ingestion and identity contracts
...
The ingest layer processes inbound email receipts.
...
These are not necessarily tables but logical views derived from receipts.
...
Represents a calendar day of spending.

Derived from receipt timestamps.
...
Represents rolling yearly spending.
...
Database contract is considered implemented when:
